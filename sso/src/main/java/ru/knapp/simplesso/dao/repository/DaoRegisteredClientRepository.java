...
public class DaoRegisteredClientRepository implements RegisteredClientRepository {
    ...
    private void map(RegisteredClient dto, SystemOauth2Client entity) {
        entity.setClientId(dto.getClientId())
            .setClientIdIssueAt(dto.getClientIdIssuedAt() == null ? null : LocalDateTime.ofInstant(dto.getClientIdIssuedAt(), ZoneOffset.UTC))
            .setClientSecret(dto.getClientSecret())
            .setClientSecretExpiresAt(dto.getClientSecretExpiresAt() == null ? null : LocalDateTime.ofInstant(dto.getClientSecretExpiresAt(), ZoneOffset.UTC))
